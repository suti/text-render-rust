...
impl Transform {
    ...
    pub fn new_rotate(angle: f32) -> Self {
        let v = angle / 180.0f32 * (f64::consts::PI as f32);
        let a =  v.cos();
        let b =  v.sin();
        let c = -b;
        let d =  a;
    ...
    pub fn get_skew(&self) -> (f32, f32) {
        let rad = 180.0 / (f64::consts::PI as f32);
